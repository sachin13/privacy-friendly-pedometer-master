...
*/
package pedometer.step.com.m_step.services;
...
import pedometer.step.com.m_step.persistence.StepCountDbHelper;
import pedometer.step.com.m_step.persistence.WalkingModeDbHelper;
import pedometer.step.com.m_step.utils.AndroidVersionHelper;
...
public class HardwareStepCounterService extends AbstractStepDetectorService{
    ...
    protected void onStepDetected(int count) {
        ...
        // broadcast the event
        localIntent = new Intent(StepCountPersistenceHelper.BROADCAST_ACTION_STEPS_SAVED);
        // Broadcasts the Intent to receivers in this app.
        LocalBroadcastManager.getInstance(this).sendBroadcast(localIntent);
        updateNotification();
        stopSelf();
